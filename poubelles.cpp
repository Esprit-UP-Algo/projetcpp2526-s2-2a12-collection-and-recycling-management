...
Poubelle::Poubelle(int id, QString loc, int niv, int cap, QString type, int zone, QString et, QDate date) {
    this->id_poubelle = id;
...
bool Poubelle::ajouter() {
    QSqlQuery query;
    query.prepare("INSERT INTO POUBELLE (TYPE, CAPACITE_MAX, NIVEAU_REMPLISSAGE, ETAT, LOCALISATION, DATE_VIDANGE, ID_ZONE) "
...
QSqlQueryModel* Poubelle::afficher() {
    ...
    model->setQuery("SELECT ID_POUBELLE, TYPE, CAPACITE_MAX, NIVEAU_REMPLISSAGE, LOCALISATION, ETAT, DATE_VIDANGE, ID_ZONE "
